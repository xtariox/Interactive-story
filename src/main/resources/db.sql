...
# Prologue
    (0, 'The Invitation', CONCAT(
            ...
            CHAR(10),
            '<em>"You are invited to visit the Mansion of the Forgotten, a place where answers await those willing to seek them."</em>',
            CHAR(10),
            ...
            'But there''s a catch.',
            CHAR(10),
            '<em>"The Mansion does not welcome the faint-hearted. Only the brave may discover its secrets, and only those willing to face the darkness within shall survive."</em>',
            CHAR(10),
...
# Chapter 11
    (11, 'The Flickering Light', CONCAT(
            ...
            CHAR(10),
            'As you step closer, you notice something written on the table in what looks like dried ink—or perhaps something darker. The words are scrawled in jagged, uneven lines: <em>“Only the light will reveal the truth.”</em>',
            CHAR(10),
...
# Chapter 14
    (14, 'The Visions', CONCAT(
            ...
            CHAR(10),
            'Figures move in the shadows—silent, faceless beings that seem to watch your every move. A voice echoes in your mind, speaking in a language you don’t understand, yet the meaning is clear: <em>You shouldn’t be here</em>.',
            CHAR(10),
...
# Chapter 15
    (15, 'The Covered Object', CONCAT(
            ...
            CHAR(10),
            'Her voice echoes in your mind: <em>“You’ve come so far. Will you open the final door?”</em>',
            CHAR(10),
...
# Chapter 16
    (16, 'The Mirror’s Truth', CONCAT(
            ...
            CHAR(10),
            'The woman’s voice echoes faintly in your ears: <em>“The truth lies within, but are you prepared to face it?”</em>',
            CHAR(10),
...
# Chapter 17
    (17, 'The Hidden Drawer', CONCAT(
            ...
            CHAR(10),
            'The pages are yellowed, and the handwriting is frantic, almost illegible. Skimming through, you decipher fragmented sentences: <em>“...the house demands sacrifices... shadows grow stronger... the last key lies with her…”</em>',
            CHAR(10),
            ...
            CHAR(10),
            'As you turn the photo over, words scrawled in ink catch your eye: <em>“She watches from the mirrors.”</em>')),
...
# Chapter 18
    (18, 'The Final Door', CONCAT(
            ...
            CHAR(10),
            'Inscribed on the altar are words in a language you can’t read, but their meaning resonates in your mind: <em>“A choice must be made.”</em>')),
...
# Chapter 19
    (19, 'Guiding Light', CONCAT(
            ...
            CHAR(10),
            'A voice, calm yet commanding, resonates in your mind: <em>“You have sought the truth. Take this light as your guide.”</em>',
            CHAR(10),
            ...
            CHAR(10),
            'Suddenly, the voice warns: <em>“The light will guide you, but it cannot protect you.”</em>')),
...
# Chapter 20
    (20, 'Darkness Unleashed', CONCAT(
            ...
            CHAR(10),
            'A voice, not your own, speaks in your mind: <em>“You’ve gone too far. Now you face the consequences.”</em>')),
...
# Chapter 21
    (21, 'The Box’s Secret', CONCAT(
            ...
            CHAR(10),
            'The orb whispers directly to your thoughts: <em>“Take me, and I will grant you power. Leave me, and the truth will elude you.”</em>',
            CHAR(10),
...
# Chapter 22
    (22, 'Beneath the Floorboards', CONCAT(
            ...
            CHAR(10),
            '<em>“The house feeds on our despair. Only by offering it what it seeks can we escape its grasp. I am sorry for what I must do.”</em>',
            CHAR(10),
...
# Chapter 23
    (23, 'The Final Door', CONCAT(
            ...
            CHAR(10),
            'The woman’s voice returns, softer now: <em>“This is where it ends, where the truth is revealed. Will you face it, or turn back?”</em>',
            CHAR(10),
...
# Chapter 24
    (24, 'The Ritual', CONCAT(
            ...
            CHAR(10),
            '<em>“The house binds the soul. To break free, the sacrifice must be made.”</em>',
            CHAR(10),
            ...
            CHAR(10),
            '<em>“You hold the tools. The choice is yours: destroy the house or become its master.”</em>')),
...
# Chapter 26
    (26, 'The Pact', CONCAT(
            ...
            CHAR(10),
            '<em>“You seek answers, strength, freedom. I can give you all of this. But every gift demands a price. Bind yourself to me, and the truth shall be yours.”</em>',
            CHAR(10),
...
# Ending 3
    ('Liberation', CONCAT(
            ...
            CHAR(10),
            '<em>“Destroy us, and you destroy yourself! The house will not let you leave!”</em>',
            CHAR(10),
...
# Ending 4
    ('The New Master', CONCAT(
            ...
            CHAR(10),
            '<em>“You have chosen well. The house is yours to command.”</em>',
            CHAR(10),
...
# Ending 5
    ('Eternal Loop', CONCAT(
            ...
            CHAR(10),
            '<em>“Weak. Unworthy. You had the tools, yet you chose nothing. A soul adrift, a fool lost to fear.”</em>',
            CHAR(10),
...
# Ending 6
    ('A Warrior’s End', CONCAT(
            ...
            CHAR(10),
            '<em>“Foolish... stubborn... a pointless fight against the inevitable.”</em>',
            CHAR(10),
